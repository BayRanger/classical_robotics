...
void ForwardKinematicsPuma2D::computeF()
{
   ...
   F[0] = l1*cos(angles[0])+l2*sin(angles[0]+angles[1])+l3*sin(angles[0]+angles[1]+angles[2]); //x
   F[1] = l1*sin(angles[0])-l2*cos(angles[0]+angles[1])-l3*cos(angles[0]+angles[1]+angles[2]); //y
   F[2] = angles[0]+angles[1]+angles[2]-0.5*M_PI; //alpha
}
...
void ForwardKinematicsPuma2D::computeJ()
{
   ...
   //row vector
   J[1][0] =l1*cos(angles[0])+l2*sin(angles[0]+angles[1])+l3*(angles[0]+angles[1]+angles[2]) ;
...
// cout<<"l3="<<ForwardKinematicsPuma2D::l3<<endl;
